...
def export_story_map(
    ...
    *,
    ...
    # Add a small README into the exported site for attribution + quick start.
    export_readme = template_dir / "EXPORT_README.md"
    if export_readme.is_file():
        shutil.copy2(export_readme, output_dir / "README.md")
    else:
        (output_dir / "README.md").write_text(
            "This folder was generated by the QStoryMap QGIS plugin.\n",
            encoding="utf-8",
        )
