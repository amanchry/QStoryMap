...
KEY_GH_REMEMBER_TOKEN = "github/remember_token"
...
def load_github_settings() -> dict[str, Any]:
    ...
    data = {
        ...
        "remember_token": s.value(KEY_GH_REMEMBER_TOKEN, False, type=bool),
...
def save_github_settings(
    ...
    s.setValue(KEY_GH_REMEMBER_TOKEN, remember_token)
    if remember:
